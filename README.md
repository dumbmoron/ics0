...
a zero-dependency of fork of [ics](https://github.com/adamgibbons/ics)
...
- unicode wrapping in the description

use the original package. otherwise, this might just work for you
